...
public class Main2 {
    public static void main(String Args[]) throws IOException, SAXException, ParserConfigurationException, ClassNotFoundException, InterruptedException {
        ...
        List<FileTransmitter> fileTransmitterList =xmlToDto.readTransaction("C:\\Users\\Auser\\Desktop\\banking\\transactionsClient2.xml");
        XmlConfig xmlConfig=xmlToDto.readConfig("C:\\Users\\Auser\\Desktop\\banking\\configurationClinet2.xml");
